...
if(isset($_POST['send'])){
    ...
    if(!empty($_POST['city'])) {
        ...
        if (!empty($_POST['district'])) {
            ...
            $sql_house = "SELECT * FROM `house` JOIN `area` on `郵遞區號` = `郵遞區號` where `區名` = '$district'";
            $result_house = $conn->query($sql_house);
            $sql_facility = "SELECT * FROM `facility` JOIN `area` on `郵遞區號` = `郵遞區號` where `區名` = '$district'";
...
$sql= SELECT `經度`, `緯度` FROM house NATURAL JOIN `house_picture`');
                ...
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-3 mt-lg-0 text-center">
                        ...
                        <div class="position-relative w-75 mx-auto animated slideInDown">
                            <select class="form-control border-0 rounded-pill w-100 py-3 ps-4 pe-5 custom-select" id="county" name="city" placeholder="縣市">
                                <option value="全選">縣市</option>
                                 
                            </select>
                            <select class="form-control border-0 rounded-pill w-100 py-3 ps-4 pe-5 mt-3" id="district" name="district" placeholder="鄉鎮地區">
                                <option value="全選">鄉鎮市區</option>
                                 
                            </select>
                            <select class="form-control border-0 rounded-pill w-100 py-3 ps-4 pe-5 mt-3" id="ethnicity" name="ethnicity" placeholder="族群">
                                <option value="全選">族群</option>
                                 
                            </select>
                            <select class="form-control border-0 rounded-pill w-100 py-3 ps-4 pe-5 mt-3" id="objective" name="objective" placeholder="看屋目標">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item rounded pt-3" style="height: 250px;">
                        <div class="p-4">
                            ...
                            <br>
                            <br>
                            <input type="submit" class="btn btn-primary rounded-pill py-2 px-4" name="send" value="search">
